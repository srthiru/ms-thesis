...
\section{Experiment Setup}
 % This first sentence needs reworking, does not sound correct
 (\rev{something wrong; this sentence doesn't parse.
...
(\rev{Explain how this was chosen as you did for other parameters below.})
