...
\rev{Remove overlaps with introduction, and shorten a bit.
}
...
We evaluate the performance of these algorithms in benchmark extensive-form games under function
approximation and summarize our findings regarding the effectiveness of mirror-descent-based
reinforcement learning algorithms in the multiagent setting and the effect of the modifications we
apply.
